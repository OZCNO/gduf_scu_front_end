...
<div class="officerManageContainer">
	...
	<el-table :data="studentList" :highlight-current-row="true" v-loading="listLoading"  @selection-change="selectionChange"  style="width: 100%" class="tableClass" size="mini">
		...
		</el-table-column> --><el-table-column prop="code" label="学号" sortable width="100">	
		...
		<el-table-column label="操作" width="150" fixed="right">
			<template slot-scope="scope">
				...
				<el-button type="danger" size="mini" @click="handleDel(scope.$index, scope.row)">剔除</el-button>
			</template>
		</el-table-column>
	</el-table>
...
export default{
	...
	data(){
		return{
			...
			editLoading:false,
			cname:['姓名','性别',"学号","学院","专业","手机号码","邮箱"],
			ename:['name','sex',"code","institudeName","major","mobile","email"],
